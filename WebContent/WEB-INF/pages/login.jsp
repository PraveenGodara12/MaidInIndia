...
<body style="background-color:#ebf0fa;">
  <div class="cont1 col-12">
    <div class="row row-header top-bar">
      ...
      <div class="d-none d-sm-block col-sm-1 d-inline">
        <a href="signup"><button class="login-but">Sign Up</button></a>
      </div>
    </div>
    <div class="login-area">
      <h2 style="color: #142952;text-shadow: 1px 1px #85a3e0; margin-top:10px;text-decoration: underline;">Login Form</h2>
      <p>${msg}</p>
      <form action="verifyLogin" method="POST" class="register-form" id="register-form">
