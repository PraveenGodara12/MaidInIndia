...
<body style="background-color:#ebf0fa;">
  <div class="cont1 col-12">
    ...
    <div class="login-area">
      <h3 style="color: #142952;text-shadow: 1px 1px #85a3e0; margin-top:100px;">You have successfully booked your maid.<br>Our officials would be contacting you shortly and the service will be available shortly.<br>Thank You for booking with us!</h3>
      <h3 style="color: #142952;text-shadow: 1px 1px #85a3e0; margin-top:50px;text-decoration:underline;">Click "Home" to go to Home Page</h3>
    </div>
  </div>
