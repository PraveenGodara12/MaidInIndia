...
<body style="background-color:#ebf0fa;">
  <div class="cont2 col-12">
    <div class="row row-header top-bar">
      ...
      <div class="d-none d-sm-block col-sm-1 d-inline">
        <a href="login"><button class="login-but">Login</button></a>
      </div>
    </div>
    <div class="signup-area">
      <h2 style="color: #142952;text-shadow: 1px 1px #85a3e0; margin-top:10px;text-decoration: underline;">Signup Form</h2>
      <form action="addcustomer" method="POST" class="register-form" id="register-form">
        <div class="signup-block">
          <div class="signup-item">
            <label for="first_name" style="font-weight:500;">First Name</label>
            <input type="text" class="text-input" name="first_name" id="first_name" placeholder="Enter First Name" />
          </div>
          <div class="signup-item">
            <label for="last_name" style="font-weight:500;">Last Name</label>
            <input type="text" class="text-input" name="last_name" id="last_name" placeholder="Enter Last Name" />
          </div>
          <div class="signup-item">
            <label for="email" style="font-weight:500;">Email</label>
            <input type="text" class="text-input" name="email" id="email" placeholder="Enter Email" />
          </div>
          <div class="signup-item">
            <label for="phone" style="font-weight:500;">Phone</label>
            <input type="text" class="text-input" name="phone" id="phone" placeholder="Enter Phone" />
          </div>
          <div class="signup-item">
            <label for="city" style="font-weight:500;">City</label>
            <input type="text" class="text-input" name="city" id="city" placeholder="Enter City" />
          </div>
          <div class="signup-item">
            <label for="password" style="font-weight:500;">Password</label>
            <input type="password" class="text-input" name="password" id="password" placeholder="Enter Password" />
          </div>
        </div>
